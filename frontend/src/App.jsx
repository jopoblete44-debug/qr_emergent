  ...
  <Layout>
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mb-6">Tu orden ha sido procesada correctamente</p>
        <a href="/dashboard" className="text-primary hover:underline">Ir al Dashboard</a>
      </div>
    </div>
  </Layout>
);
